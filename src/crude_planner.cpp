...
CrudePlanner::CrudePlanner(void)
{
	...
	//odom_sub = nh.subscribe<geometry_msgs::PoseWithCovarianceStamped>("amcl_pose", 10, &CrudePlanner::PoseCallback, this);
...
void CrudePlanner::PoseCallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr& msg)
{
